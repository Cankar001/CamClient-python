...
class Camera:
    def __init__(self, mirror=False, motion_detection_reference_frame_threshold=512, motion_detection_threshold=500, seconds_until_monitor_off=300, show_debug_text=False):
        self.data = None
